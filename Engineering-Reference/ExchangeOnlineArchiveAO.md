...
2. [Direct Exchange EWS URL](#directewsurl)
3. [Autodiscovery Service URL](#autourl)
3. [Use Workstation Credentials](#workcred)
...
The optional direct Exchange EWS server URL if the server for all users is known and constant. Used in preference of the Autodiscovery URL if present. Usually, autodiscovery should be used.

Change Conditions: ??

### Autodiscovery Service URL <a name="autourl"></a>
{: .no_toc }
Default Value: https://autodiscover-s.outlook.com/autodiscover/autodiscover.svc
